...
@router.get("/logs")
def list_logs(_permission: None = Depends(require_permission("system:audit:read")), db: Session = Depends(get_db)):
...
def create(
    ...
    _permission: None = Depends(require_permission("system:audit:read")),
